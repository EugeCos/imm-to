...
class FormNationality extends Component {
    render () {
        ...
        <center>
        <h4>Your country of citizenship</h4>
        <br></br>
        <select id="nationality" name="country" onChange={this.props.formFunction}>
        ...
        <br></br><br></br>
            <Link className='backLink' to={"/" + provinceId + "/form2"}>Back</Link>
            &nbsp; &nbsp;
            <Link to={ "/" + provinceId + "/form4" }><button type="submit" className="btn btn-primary">Next</button></Link>
            <br></br>
            <h6>Question 3 / 8</h6>
            </center>
        </div>        
